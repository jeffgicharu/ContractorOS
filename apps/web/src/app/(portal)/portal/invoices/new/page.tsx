            ...
            <div>
              <label className="block text-sm font-medium text-slate-700">
                ...
                <input
                  ...
                  required
                  className="mt-1 block w-full rounded-md border border-slate-200 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
                />
              </label>
            </div>
            <div>
              ...
              <div key={idx} className="grid grid-cols-12 gap-3 items-end">
                ...
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    placeholder="0"
                    required
                    className="mt-1 block w-full rounded-md border border-slate-200 px-3 py-2 text-sm text-right font-mono"
                  />
                </div>
                <div className="col-span-2">
                  {idx === 0 && (
